...
class BA3DetBackbone(nn.Module):
    def __init__(self, in_channels=3, base_channels=64):
        super(BA3DetBackbone, self).__init__()
        ...
        self.dark3 = nn.Sequential(
            CBS(base_channels * 2, base_channels * 4, kernel_size=3, stride=2, padding=1),
            FCABlock(base_channels * 4, base_channels * 4, n=9),
        )

        self.dark4 = nn.Sequential(
            CBS(base_channels * 4, base_channels * 8, kernel_size=3, stride=2, padding=1),
